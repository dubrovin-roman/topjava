...
<section>
    <div class="jumbotron pt-4">
        <div class="container">
            ...
            <div>
                <button class="btn btn-secondary mr-2" onclick="clearFilter()"><spring:message code="meal.clearFilter"/></button>
            ...
            <div class="modal-body">
                <form id="detailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="description" name="description" size="40" required>
                    </div>
