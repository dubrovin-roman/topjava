...
public class MealTestData {
    ...
    public static final Meal userMeal1 = new Meal(USER_MEAL_1_ID,
            LocalDateTime.of(2024, 2, 21, 8, 5), "Завтрак", 1000);
    public static final Meal userMeal2 = new Meal(USER_MEAL_2_ID,
            LocalDateTime.of(2024, 2, 21, 13, 30), "Обед", 1500);
    public static final Meal userMeal3 = new Meal(USER_MEAL_3_ID,
            LocalDateTime.of(2024, 2, 21, 18, 10), "Ужин", 1000);
    public static final Meal userMeal4 = new Meal(USER_MEAL_4_ID,
            LocalDateTime.of(2024, 2, 22, 8, 10), "Завтрак", 600);
    public static final Meal userMeal5 = new Meal(USER_MEAL_5_ID,
            LocalDateTime.of(2024, 2, 22, 14, 25), "Обед", 900);
    public static final Meal userMeal6 = new Meal(USER_MEAL_6_ID,
            LocalDateTime.of(2024, 2, 22, 19, 0), "Ужин", 450);
    public static final Meal adminMeal1 = new Meal(ADMIN_MEAL_1_ID,
            LocalDateTime.of(2024, 2, 10, 8, 5), "Завтрак", 3000);
    public static final Meal adminMeal2 = new Meal(ADMIN_MEAL_2_ID,
            LocalDateTime.of(2024, 2, 10, 13, 30), "Обед", 1500);
    public static final Meal adminMeal3 = new Meal(ADMIN_MEAL_3_ID,
            LocalDateTime.of(2024, 2, 10, 18, 10), "Ужин", 1000);
    public static final Meal adminMeal4 = new Meal(ADMIN_MEAL_4_ID,
            LocalDateTime.of(2024, 2, 15, 8, 10), "Завтрак", 750);
    public static final Meal adminMeal5 = new Meal(ADMIN_MEAL_5_ID,
            LocalDateTime.of(2024, 2, 15, 14, 25), "Обед", 900);
    public static final Meal adminMeal6 = new Meal(ADMIN_MEAL_6_ID,
            LocalDateTime.of(2024, 2, 15, 19, 0), "Ужин", 250);
    ...
    public static Meal getNew() {
        return new Meal(LocalDateTime.now(), "Test meal", 1000);
    }
